...
Basho also develops a Riak backend named Innostore based on the embeddable version of InnoDB. Due to licensing restrictions, Innostore is provided separately. You can read more about configuring Innostore [[here|Innostore]].
...
h3. Query via HTTP, Protocol Buffers, or MapReduce
