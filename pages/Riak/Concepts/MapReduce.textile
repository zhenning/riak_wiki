Riak's primary querying and data-processing system is an implementation of the MapReduce programming paradigm popularized by [[Google|http://research.google.com/archive/mapreduce.html]].
...
h2(#erlang). MapReduce via the Protocol Buffers API using Erlang Syntax
