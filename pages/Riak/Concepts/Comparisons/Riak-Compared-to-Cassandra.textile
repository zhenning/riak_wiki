...
<table>
    ...
    <tr>
        <td>Largest Value Supported</td>
        <td>64MB * /5GB ** </td>
        <td>2GB</td>
    </tr>
    <tr>
        <td>Time-to-Live (TTL) Support</td>
        <td>Yes</td>
        <td>No</td>
    </tr>
    <tr>
        <td>Conditional Updates</td>
        <td>Yes</td>
        <td>No</td>
    </tr>
    <tr>
        <td>Secondary Indexing</td>
        <td>Yes</td>
        <td>Yes</td>
    </tr>
    <tr>
        <td>Hadoop Integration</td>
        <td>Open-Source Connector</td>
        <td>M/R, Hive, Pig</td>
    </tr>
    <tr>
        <td>Multi-Data Center Support</td>
        <td>Full Cross-Region * </td>
        <td>Full Cross-Region</td>
    </tr>
    <tr>
        <td>Integrated Caching</td>
        <td>Yes</td>
        <td>Yes</td>
    </tr>
    <tr>
        <td>Uses Commodity Disks</td>
        <td>Yes</td>
        <td>Yes</td>
    </tr>
    <tr>
