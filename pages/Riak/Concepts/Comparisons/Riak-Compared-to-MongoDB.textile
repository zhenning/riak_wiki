...
<table>
	...
	<tr>
        ...
        <td>MongoDB relies on locks for consistency. As of 2.2, MongoDB has a DB Level Lock. 
			<ul>
				<li><a href="http://docs.mongodb.org/manual/administration/monitoring/#locks">Locks</a></li>
				<li><a href="https://jira.mongodb.org/browse/SERVER-4328">DB Level Locking</a></li>
				<li><a href="http://www.mongodb.org/display/DOCS/How+does+concurrency+work">How Does Concurrency Work?</a></li>
			</ul>			
	 </td>
    </tr>
    <tr>
	...
	<ul>
        ...
        <td>Mongo relies on [[sharding|http://en.wikipedia.org/wiki/Sharding]] for scaling out. This involves designating a certain server to hold certain chunks of the data as the data set grows.  
