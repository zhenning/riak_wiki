...
<table>
    ...
    <tr>
        ...
        <td>HBase's storage system is the Hadoop Distributed File System (HDFS). Data is stored in MemStores and StoreFiles, where data is streamed to disk (implemented via HFiles, a format based on BigTable's SSTable). Implementations generally use the native JVM-managed I/O file stream.
			<ul>
