...
"Yammer":http://www.yammer.com is the leader in enterprise social networking, providing a secure way for employees to communicate, collaborate, and share information.
...
<notextile>
<a name="bump">
<img src="attachments/bump_logo.png">
</a>
</notextile>

Recently named the #7 free app of all time by Apple, "Bump":http://bu.mp is a quick and easy way to connect two phones, simply by bumping them together.

With 50+ million users, Bump uses Riak to store records for everything sent through the Bump App and continue to migrate more data as they continue to expand.

---

<notextile>
<a name="seomoz">
<img src="attachments/seomoz_logo.jpg">
</a>
</notextile>

"SEOmoz":http://seomoz.org makes industry-leading SEO software that makes it easy to track and improve your website's organic marketing performance.

SEOmoz uses Riak to reliably store and process millions of search engine rankings every week, and has contributed extensively to "Ripple":https://github.com/seancribbs/ripple, the Ruby Riak client library.

--- 

<notextile>
<a name="worthpoint">
<img src="attachments/worthpoint_header_logo.gif ">
</a>
</notextile>

Founded in 2007, "WorthPoint":http://www.worthpoint.com is an international, online information and media company that has quickly become the world’s largest resource for researching art, antiques and collectibles. It helps people accurately value, preserve, buy and/or sell items. The company’s core feature is a vast database of sales records, known as "Worthopedia", which has aggregated (to date) more than 100 million items from eBay, virtual marketplaces and leading auction houses. In 2011 WorthPoint was named one of the fastest growing technology companies in Georgia and also has offices in Ohio and Ireland. 

WorthPoint uses Riak as the primary storage system for Worthopedia. Specifically, Riak was chosen for its: 

* reliability
* ability to scale
* excellent "Java client":https://github.com/basho/riak-java-client support

"Getting a Riak test cluster up and running, complete with a five line Groovy script to start pumping in data, took less than 30 minutes on the first try. After that, we were hooked." *Mac Liaw, CTO, Worthpoint*

--- 

<notextile>
<a name="thenetcircle">
<img src="attachments/logo-tnc.png">
</a>
</notextile>

At "The NetCircle":http://www.thenetcircle.com, we are passionate about connecting people around the globe - not only by building web community software, but also by contributing to the open source community. We’re nerds at heart and love being part of the web advance.

Riak plays an integral role in our clients' web communities as our direct messaging service data store. Hundreds of thousands of messages are stored daily for multiple communities through our Riak-backed messaging service.

* "Using Riak at The NetCircle":http://www.thenetcircle.com/2011/09/19/using-riak-at-the-netcircle
