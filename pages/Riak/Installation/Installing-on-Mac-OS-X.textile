...
```bash
$ curl -O http://downloads.basho.com/riak/riak-1.1.1/riak-1.1.1-osx-x86_64.tar.gz
$ tar xzvf riak-1.1.1-osx-x86_64.tar.gz
```
...
```bash
$ curl -O http://downloads.basho.com/riak/riak-1.1.1/riak-1.1.1.tar.gz
