...
h3. Node, Cluster & System Information

h2. CPU and Memory

CPU statistics are taken directly from Erlang's cpu\_sup module. [ErlDocs: cpu_sup](http://erldocs.com/R14B04/os_mon/cpu_sup.html?i=0&search=cpu#undefined)
...
Memory statistics are taken directly from the Erlang virtual machine. [ErlDocs: Memory](http://erldocs.com/R14B04/erts/erlang.html?i=0&search=erlang:memory#memory/0)
...
* @vnode_gets_total@: Number of PUT operations coordinated by vnodes on this node since node was started
