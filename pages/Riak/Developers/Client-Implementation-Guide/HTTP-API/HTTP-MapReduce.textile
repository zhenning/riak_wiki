...
```bash
$ curl -v -d '{"inputs":"test", "query":[{"link":{"buckets":"test"}},{"map":{"language":"javascript","name":"Riak.mapValuesJson"}}]}' -H "Content-Type: application/json" http://127.0.0.1:8098/mapred
