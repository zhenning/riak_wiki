Comcast, Yammer, Voxer, Boeing, BestBuy, SEOMoz, Joyent, Kiip, DotCloud, Formspring, GitHub, and the Danish Government are just a few of the thousands of startups and enterprises that have deployed Riak (click [[here|http://basho.com/company/production-users/]] for a list of deployments we're allowed to announce).  

This page is a collection of videos, slides, papers, and other media detailing how Riak was deployed in various production environments.  *(If you have a video to add, please fork the "Riak Wiki Repo on GitHub":https://github.com/basho/riak_wiki and do so.)*
