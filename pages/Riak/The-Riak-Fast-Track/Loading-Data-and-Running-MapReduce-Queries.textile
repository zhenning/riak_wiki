Riak provides three ways to query your data beyond the basic key/value operations: [[Full-Text Search|Riak Search]], [[MapReduce|MapReduce]] and  [[Secondary Indexes|Secondary Indexes]].
