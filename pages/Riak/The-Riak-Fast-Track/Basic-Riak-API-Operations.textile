...
In the output, the *Location* header will give the you key for that object. To view the newly created object, go to "http://127.0.0.1:8098/*_Location_*" in your browser.
...
You can also view this Bucket information through any browser by going to "http://127.0.0.1:8098/riak/test"
