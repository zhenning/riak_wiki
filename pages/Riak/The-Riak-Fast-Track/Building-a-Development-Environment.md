...
The current version is 1.0.3, and you can download the [source code
here](http://downloads.basho.com/riak/riak-1.0.3/riak-1.0.3.tar.gz). Unpack the package once downloaded, and you're
