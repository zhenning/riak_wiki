...
If you're using the [[Basho supplied Riak packages|http://downloads.basho.com/riak/]], there's no need for any extra software packages. Should you decide to build the Riak installation from source, you'll need to have Erlang installed on your systems, release R13B04 to install the current Riak version 0.14.2. See our [[wiki page|Installing Erlang]] for instruction on building and installing Erlang.  
